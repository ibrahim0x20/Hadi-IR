...
class MPEngineProdCons(object):
    ...
    def startProducers(self, num_producers, extra_arg_list = []):
        ...
        if num_producers is None:
            for i in range(self.maxCores - 1): self.addProducer(extra_arg_list)
        else:
            for i in range(num_producers): self.addProducer(extra_arg_list)
    ...
    def restartProducers(self):
        ...
        # Shut them all down
        for i in range(current_num_producers):
            # Grab extra_arg_list
    ...
    def endProducers(self):
        ...
        for i in range(self.num_producers): self.removeProducer()
    ...
    def startConsumers(self, num_consumers, extra_arg_list = []):
        ...
        if num_consumers is None:
            for i in range(self.maxCores - 1): self.addConsumer(extra_arg_list)
        else:
            for i in range(num_consumers): self.addConsumer(extra_arg_list)
    ...
    def restartConsumers(self):
        ...
        # Shut them all down
        for i in range(current_num_consumers):
            # Grab extra_arg_list
    ...
    def endConsumers(self):
        ...
        for i in range(self.num_consumers): self.removeConsumer()

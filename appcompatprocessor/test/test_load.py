...
class TestAppLoadMP(TestCase):
    ...
    def test_SimpleLoadAppCompat(self):
        ...
        self.assertEqual(num_hosts, 22, "test_SimpleLoadAppCompat failed!")
        self.assertEqual(num_instances, 22, "test_SimpleLoadAppCompat failed!")
        self.assertEqual(num_entries, 11561, "test_SimpleLoadAppCompat failed!")
    ...
    def test_SimpleLoadAmCache(self):
        ...
        self.assertEqual(num_hosts1, 6, "test_SimpleLoadAmCache failed!")
        self.assertEqual(num_entries1, 31260, "test_SimpleLoadAmCache failed!")
    ...
    def test_MultipleInstancesLoadAppCompat(self):
        ...
        self.assertEqual(num_hosts1, 1, "test_MultipleInstancesLoadAppCompat failed!")
        self.assertEqual(num_instances1, 1, "test_MultipleInstancesLoadAppCompat failed!")
    ...
    def test_MultipleInstancesLoadAppCompat2(self):
        ...
        self.assertEqual(num_hosts1, 1, "test_MultipleInstancesLoadAppCompat2 failed!")
        if num_instances1 == 2:
            print("stop")
        self.assertEqual(num_instances1, 1, "test_MultipleInstancesLoadAppCompat2 failed!")
        ...
        self.assertEqual(num_hosts1, 1, "test_MultipleInstancesLoadAppCompat2 failed!")
        self.assertEqual(num_hosts2, 1, "test_MultipleInstancesLoadAppCompat2 failed!")
        self.assertEqual(num_instances1, 1, "test_MultipleInstancesLoadAppCompat2 failed!")
        self.assertEqual(num_instances2, 2, "test_MultipleInstancesLoadAppCompat2 failed!")
        self.assertEqual(num_entries2, num_entries1 * 2, "test_MultipleInstancesLoadAppCompat2 failed!")
    ...
    def test_MultipleInstancesLoadAppCompat3(self):
        ...
        self.assertEqual(num_hosts1, 1, "test_MultipleInstancesLoadAppCompat3 failed!")
        self.assertEqual(num_hosts2, 1, "test_MultipleInstancesLoadAppCompat3 failed!")
        self.assertEqual(num_instances1, 1, "test_MultipleInstancesLoadAppCompat3 failed!")
        self.assertEqual(num_instances2, 1, "test_MultipleInstancesLoadAppCompat3 failed!")
        self.assertEqual(num_entries1, num_entries2, "test_MultipleInstancesLoadAppCompat3 failed!")
    ...
    def test_MultipleInstancesLoadAppCompat4(self):
        ...
        self.assertEqual(num_hosts1, 1, "test_MultipleInstancesLoadAppCompat4 failed!")
        self.assertEqual(num_hosts2, 1, "test_MultipleInstancesLoadAppCompat4 failed!")
        self.assertEqual(num_instances1, 1, "test_MultipleInstancesLoadAppCompat4 failed!")
        self.assertEqual(num_instances2, 2, "test_MultipleInstancesLoadAppCompat4 failed!")
        self.assertEqual(num_entries1 * 2, num_entries2, "test_MultipleInstancesLoadAppCompat4 failed!")
    ...
    def test_AddExistingHostsAppCompat(self):
        ...
        self.assertEqual(num_hosts1, num_hosts2, "test_SimpleLoad failed!")
        self.assertEqual(num_entries1, num_entries2, "test_SimpleLoad failed!")
    ...
    def test_AddExistingHosts_PreProcessed(self):
        ...
        self.assertEqual(num_hosts1, num_hosts2, "test_AddExistingHosts_PreProcessed failed!")
        self.assertEqual(num_entries1, num_entries2, "test_AddExistingHosts_PreProcessed failed!")
    ...
    def test_AddNewHostsAppCompat(self):
        ...
        self.assertEqual(num_hosts1 * 2, num_hosts2, "test_AddNewHostsAppCompat failed!")
        self.assertEqual(num_entries1 * 2, num_entries2, "test_AddNewHostsAppCompat failed!")
        self.assertEqual(num_hits1 * 2, num_hits2, "test_AddNewHostsAppCompat failed!")
    ...
    def test_AddExistingHostsAmCache(self):
        ...
        self.assertEqual(num_hosts1, num_hosts2, "test_AddExistingHostsAmCache failed!")
        self.assertEqual(num_entries1, num_entries2, "test_AddExistingHostsAmCache failed!")
        self.assertEqual(num_instances1, num_instances2, "test_AddExistingHostsAmCache failed!")
    ...
    def test_AddNewHostsAmCache(self):
        ...
        self.assertEqual(num_hosts1 * 2, num_hosts2, "test_AddNewHostsAmCache failed!")
        self.assertEqual(num_entries1 * 2, num_entries2, "test_AddNewHostsAmCache failed!")
        self.assertEqual(num_hits1 * 2, num_hits2, "test_AddNewHostsAmCache failed!")
    ...
    def test_RecursiveLoad(self):
        ...
        self.assertEqual(num_hosts, 23, "test_RecursiveLoad failed!")
        self.assertEqual(num_entries, 12442, "test_RecursiveLoad failed!")
    ...
    def __test_ZipLoadAppCompat(self):
        ...
        self.assertEqual(num_hosts, 22, "test_ZipLoadAppCompat failed!")
    ...
    def __test_ZipLoadAmCache(self):
        ...
        self.assertEqual(num_hosts, num_hosts2, "test_ZipLoadAmCache failed!")
        self.assertEqual(num_instances, num_instances2, "test_ZipLoadAmCache failed!")
        self.assertEqual(num_entries, num_entries2, "test_ZipLoadAmCache failed!")
    ...
    def __test_ZipLoadRecursive(self):
        ...
        self.assertEqual(num_hosts, 22, "test_ZipLoadRecursive failed!")
    ...
    def __test_ZipLoadRecursive2(self):
        ...
        self.assertEqual(num_hosts, num_hosts2, "test_ZipLoadRecursive failed!")
        self.assertEqual(num_instances, num_instances2, "test_ZipLoadRecursive failed!")
        self.assertEqual(num_entries, num_entries2, "test_ZipLoadRecursive failed!")

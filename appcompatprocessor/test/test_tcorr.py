...
class TestAppTcorr(TestCase):
    ...
    def test_TcorrTest_prog1(self):
        with appDB.DBClass(self.testset1, settings.__version__) as DB:
            ...
            # Check Names
            self.assertEqual(directCorrelationData[1][3], "CCC.exe", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[0][3], "EEE.exe", "test_TcorrTest_prog1 - Name failed!")
            # Check Before
            self.assertEqual(directCorrelationData[1][6], 0, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[0][6], 2, "test_TcorrTest_prog1 - Name failed!")
            # Check After
            self.assertEqual(directCorrelationData[1][7], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[0][7], 0, "test_TcorrTest_prog1 - Name failed!")
            # Check InvBond
            self.assertEqual(directCorrelationData[1][9], "True", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[0][9], "True", "test_TcorrTest_prog1 - Name failed!")
            # Check Total_Count
            self.assertEqual(directCorrelationData[1][10], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[0][10], 2, "test_TcorrTest_prog1 - Name failed!")
            ...
            # Check Names
            self.assertEqual(directCorrelationData[0][3], "CCC.exe", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][3], "EEE.exe", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[2][3], "BBB.exe", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[3][3], "FFF.exe", "test_TcorrTest_prog1 - Name failed!")
            # Check Before
            self.assertEqual(directCorrelationData[0][6], 0, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][6], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[2][6], 0, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[3][6], 2, "test_TcorrTest_prog1 - Name failed!")
            # Check After
            self.assertEqual(directCorrelationData[0][7], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][7], 0, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[2][7], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[3][7], 0, "test_TcorrTest_prog1 - Name failed!")
            # Check InvBond
            self.assertEqual(directCorrelationData[0][9], "True", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][9], "True", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[2][9], "True", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[3][9], "True", "test_TcorrTest_prog1 - Name failed!")
            # Check Total_Count
            self.assertEqual(directCorrelationData[0][10], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][10], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[2][10], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[3][10], 2, "test_TcorrTest_prog1 - Name failed!")
            # Check Weight
            ...
            self.assertEqual(directCorrelationData[2][3], "BBB.exe", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[3][3], "FFF.exe", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[4][3], "AAA.exe", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[5][3], "GGG.exe", "test_TcorrTest_prog1 - Name failed!")
            # Check Before
            self.assertEqual(directCorrelationData[0][6], 0, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][6], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[2][6], 0, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[3][6], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[4][6], 0, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[5][6], 2, "test_TcorrTest_prog1 - Name failed!")
            # Check After
            self.assertEqual(directCorrelationData[0][7], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][7], 0, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[2][7], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[3][7], 0, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[4][7], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[5][7], 0, "test_TcorrTest_prog1 - Name failed!")
            # Check InvBond
            self.assertEqual(directCorrelationData[0][9], "True", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][9], "True", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[2][9], "True", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[3][9], "True", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[4][9], "True", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[5][9], "True", "test_TcorrTest_prog1 - Name failed!")
            # Check Total_Count
            self.assertEqual(directCorrelationData[0][10], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][10], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[2][10], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[3][10], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[4][10], 2, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[5][10], 2, "test_TcorrTest_prog1 - Name failed!")
            # Check Weight
            self.assertTrue(directCorrelationData[0][8] > directCorrelationData[2][8], "test_TcorrTest_prog1 - Name failed!")
            self.assertTrue(directCorrelationData[0][8] > directCorrelationData[3][8], "test_TcorrTest_prog1 - Name failed!")
            ...
            # Check Before
            self.assertEqual(directCorrelationData[0][6], 0, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][6], 3, "test_TcorrTest_prog1 - Name failed!")
            # Check After
            self.assertEqual(directCorrelationData[0][7], 3, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][7], 0, "test_TcorrTest_prog1 - Name failed!")
            # Check InvBond
            self.assertEqual(directCorrelationData[0][9], "True", "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][9], "True", "test_TcorrTest_prog1 - Name failed!")
            # Check Total_Count
            self.assertEqual(directCorrelationData[0][10], 3, "test_TcorrTest_prog1 - Name failed!")
            self.assertEqual(directCorrelationData[1][10], 3, "test_TcorrTest_prog1 - Name failed!")
    ...
    def _test_TcorrMixed(self):
        ...
        # Check Name
        self.assertEqual(directCorrelationData1[0][3], "net1.exe", "test_TcorrTest1 - Name failed!")
        # Check Before
        self.assertEqual(directCorrelationData1[0][6], 0, "test_TcorrTest1 - Before failed!")
        # Check After
        self.assertEqual(directCorrelationData1[0][7], 158, "test_TcorrTest1 - After failed!")
        ...
        # Check Name
        self.assertEqual(directCorrelationData2[0][3], "net1.exe", "test_TcorrTest1 - Name failed!")
        # Check Before
        self.assertEqual(directCorrelationData2[0][6], 0 + 0, "test_TcorrTest1 - Before failed!")
        # Check After
        self.assertEqual(directCorrelationData2[0][7], 158 + 21, "test_TcorrTest1 - After failed!")
    ...
    def _test_TcorrAmCache(self):
        ...
        self.assertEqual(directCorrelationData1[0][6], 0, "test_TcorrTest1 - Before failed!")
        # Check After
        self.assertEqual(directCorrelationData1[0][7], 21, "test_TcorrTest1 - After failed!")
